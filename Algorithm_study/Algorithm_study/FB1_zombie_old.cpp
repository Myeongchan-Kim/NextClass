...
void ShowPoints(std::vector<std::pair<int,int>> point_list)
{
...
void problem_solve_old(int case_num)
{
	full_points.clear();
	groups.clear();
	std::set<Rect> rects;
	scanf("%d %d", &size, &R_old);
